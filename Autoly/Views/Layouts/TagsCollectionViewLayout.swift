...
open class TagsCollectionViewFlowLayout: UICollectionViewFlowLayout {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: TagsCollectionViewFlowLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: TagsCollectionViewFlowLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: TagsCollectionViewFlowLayout) {
    ...
    ///
    /// - Parameter collectionViewLayout: The layout on which to perfom the calculations.
    private func alignToFollowingItem(collectionViewLayout: TagsCollectionViewFlowLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: TagsCollectionViewFlowLayout) {
    ...
    func alignVertically(collectionViewLayout: TagsCollectionViewFlowLayout) {
